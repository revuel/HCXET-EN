...
<html lang = "es">
	...
	<body>
		...
		<!-- Contenido principal -->
		<main>
			<h3 class="text-center">Add one participant to a list</h3>
			<hr>
			<div class = "container">
				<div class="container row">
					...
					<div style="height:340px;" class="col-xs-12 col-sm-6 col-md-8 well " >
						...
						<form class="form-horizontal" action = "Web/Listas/accion-agregarunparticipante.php" method= "post">
							...
							<hr>
							<div class="form-group form-group-sm">
								<label class="col-sm-4 control-label" for="formGroupInputSmall">Email address:</label>
							</div>
							
							<input type="mail" class="form-control" placeholder="Type the new member's email address" name = "email" required></input>
